...
public class Ejercicio3 {
    public static void main(String[] args) { 
        ...
        for(int i=0;i<5;i++){    
            ...
            mivariable=lector.nextInt();
            if(mivariable<0){
                medianegativos += mivariable;
                contarnegativos++;
            }
            else if(mivariable>0){
                mediapositivo += mivariable;
                contarpositivos++;
            }
            else if(mivariable==0){
                contarzeros++;
            ...
            mediapositivo /=contarpositivos;
            medianegativos /=contarnegativos;
            
            System.out.print("La media de los numeros positivos es " + mediapositivo
            + " la media de los numeros negativos es " + medianegativos + " y hay " +
            contarzeros + " ceros.");
    }
}
